...
export function resetChordStepPerformance(step: ChordStep, defaults: StepCreationDefaults): ChordStep {
  return Object.freeze({
    ...
    performance: Object.freeze({
      ...
      ...(defaults.performance.manualVoicing ? { manualVoicing: Object.freeze([...defaults.performance.manualVoicing]) } : {}),
    }),
  });
}
